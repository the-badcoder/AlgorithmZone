...
public class OrFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_or, container, false);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.resultID1) {
            if ((!et1.getText().toString().isEmpty())
                ...
                Intent intent = new Intent( getActivity(), ResultOfOr.class);
            ...
            Intent intent = new Intent(getActivity(), DetailsOr.class);
            startActivity(intent);
    }
    }
}
