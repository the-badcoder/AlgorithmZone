...
public class AndFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_and, container, false);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.resultID1) {
            if ((!et1.getText().toString().isEmpty())
                ...
                Intent intent = new Intent( getActivity(), ResultOfAnd.class);
